...
def main(_):
    ...
    models = {"sst": SimpleSentimentModel('output_dir')}
    # Load SST-2 validation set from TFDS.
    datasets = {"sst_dev": SST2Data("validation")}

    # Start the LIT server. See server_flags.py for server options.

    lit_demo = dev_server.Server(models, datasets, host='0.0.0.0',**server_flags.get_flags())
    lit_demo.serve()
